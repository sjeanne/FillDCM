...
class TestFillDCM(unittest.TestCase):
    ...
    def test_verify_input_tags_tag_not_empty(self):
        ...
        self.assertRaises(
            fill_dcm.InvalidParameter, fill_dcm.verify_input_tags, fill_dcm.InputTags()
        )

        # Shall not throw
        fill_dcm.verify_input_tags(fill_dcm.InputTags({}, {"PatientID": "Value"}))

        # Shall not throw
        fill_dcm.verify_input_tags(fill_dcm.InputTags({"SeriesDate": None}, {}))
    ...
    def test_verify_input_tags_tag_to_overwrite_have_values(self):
        ...
        # shall not throw
        fill_dcm.verify_input_tags(fill_dcm.InputTags({"SeriesTime": None}, {}))
